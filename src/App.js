    ...
    <div className="overflow-hidden">
      ...
      >
        <aside className="animate__animated animate__fadeInRight w-full lg:w-1/2 flex flex-col justify-center gap-4 lg:gap-8">
          ...
          <p className="text-base lg:text-2xl text-medium font-primary text-primary">
      ...
      <section className="animate__animated animate__fadeInUp px-4 md:px-6 lg:px-20 py-12 md:py-20 flex flex-col md:flex-row flex-wrap">
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col items-center">
          <img
            ...
            className="w-20"
          />
          <h2 className="text-2xl font-primary text-primary font-medium">
            Friendly Interface
          </h2>
          <p className="text-center text-base lg:text-xl text-gray-500">
      ...
      >
        ...
        <aside className="animate__animated animate__fadeInLeft w-full md:w-1/2 flex flex-col justify-center gap-3 lg:gap-6">
          ...
          <p className="text-base lg:text-xl text-medium font-primary text-primary">
          ...
          <h2 className="text-2xl md:text-3xl font-primary text-primary font-medium">
      ...
      <section className="p-3 md:px-6 lg:px-20 pt-6 md:pt-32 flex flex-col-reverse md:flex-row">
        <aside className="animate__animated animate__fadeInLeft w-full md:w-1/2 flex flex-col gap-3 lg:gap-6">
          ...
          <ul className="columns-1 md:columns-2 text-base lg:text-xl text-gray-500 leading-relaxed">
      ...
      >
        ...
        <p className="text-base lg:text-2xl text-medium font-primary text-primary mt-3 leading-normal">
      ...
      >
        ...
        <p className="text-base lg:text-2xl text-medium font-primary text-gray-500 mt-3 leading-normal">
        ...
        <div className="columns:1 md:columns-2">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-4 mb-6 md:mb-12">
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-center md:text-left text-2xl font-primary text-primary font-bold">
                E-Ticket Generator
              </h2>
      ...
      <section className="animate__animated animate__fadeInUp px-4 md:px-6 lg:px-20 pt-12 md:pt-20 flex flex-col md:flex-row">
        ...
        <aside className="text-center w-full md:w-1/2 bg-lighter p-8 lg:p-16 rounded-xl flex flex-col gap-4 items-center">
          ...
          <p className="text-center text-base lg:text-xl text-primary">
      ...
      >
        ...
        <p className="text-center text-base lg:text-2xl text-medium font-primary text-primary mt-3 leading-normal">
      ...
      <section className="animate__animated animate__fadeInUp px-4 md:px-6 lg:px-20 py-12 md:py-20">
        <div className="columns:1 lg:columns-2">
          <article className="flex flex-col gap-3 lg:gap-6 mb-6 md:mb-10">
            ...
            <p className="text-base lg:text-xl text-primary pr-8">
      ...
      <section id="pricing" className="md:px-6 lg:px-20 pb-12 md:pb-20">
        <main className="bg-pricing-bg bg-cover bg-no-repeat bg-fixed rounded-none md:rounded-2xl flex flex-col md:flex-row gap-4 lg:gap-10 p-4">
          <aside className="w-full md:w-3/5 md:px-8 lg:px-20 py-4 flex flex-col gap-3 lg:gap-6 justify-center">
            ...
            <p className="text-base lg:text-xl text-medium font-primary text-white">
          ...
          <aside className="animate__animated animate__fadeInLeft w-full md:w-2/5 bg-white rounded-lg mb-4 md:mb-0 px-4 md:px-8 py-8 lg:p-12 flex flex-col justify-center gap-3 md:gap-6">
            <h2 className="md:text-left text-2xl md:text-3xl font-primary text-primary font-bold">
              Achieve success through WanderLinx
            </h2>
            <p className="lg:text-left text-base lg:text-xl text-medium font-primary text-gray-500">
            ...
            <a href="https://calendly.com/wanderlinxtravelservices/zoom-meeting">
              <button className="hover:bg-primary transition duration-700 px-8 py-4 bg-blue-400 text-white font-primary text-base lg:text-xl font-medium rounded-md">
